...
public class Word implements Serializable{
	...
	String Form;
	public String Lemma="_";
	public String POS="_";
	public String Deprel="_";
	String Feats="_";
	...
	public Word(Word w, boolean forCopy) {
		this.idx=w.idx;
		this.Form=w.Form;
		this.Lemma=w.Lemma;
		this.POS=w.POS;
	...
	public Word(String[] CoNLL2009Columns,Sentence s,int idx, boolean useGold){

			this(CoNLL2009Columns[1], CoNLL2009Columns[2], CoNLL2009Columns[4], CoNLL2009Columns[6], s, idx);
